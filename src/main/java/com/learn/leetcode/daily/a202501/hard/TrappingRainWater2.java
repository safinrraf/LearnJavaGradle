...
/**
 * <a href="https://leetcode.com/problems/trapping-rain-water-ii/description/?envType=daily-question&envId=2025-01-19">Task</a>
 * <br><a href="https://leetcode.com/problems/trapping-rain-water-ii/editorial/?envType=daily-question&envId=2025-01-19">Explanation</a>
 * <ul>Topics
 * <li> {@code Array, Breadth-First Search, Heap (Priority Queue), Matrix}
 * </ul>
 * <ul>Hints
 * <li> {@code ...}
 * </ul>
 * <ul><b>Constraints</b>:
 * <li> {@code m == heightMap.length}
 * <li> {@code n == heightMap[i].length}
 * <li> {@code 1 <= m, n <= 200}
 * <li> {@code 0 <= heightMap[i][j] <= 2 * 10^4}
 * </ul>
 * <br>@since 1.0.0
 * <br> 19.01.25 12:01
 */
public final class TrappingRainWater2 {

    /**
     * Approach: BFS + Priority Queue
     * <p>
     * {@code Time Complexity O(M * N * LogM * N)}<br>
