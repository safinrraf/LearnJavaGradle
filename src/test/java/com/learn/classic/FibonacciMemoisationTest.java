...
class FibonacciMemoisationTest {
    ...
    void fibonacci1(long input, long expected) {
        assertEquals(expected, FibonacciMemoisation.fibonacci(input));
    }

    @ParameterizedTest
    @MethodSource("testCases")
    void fibonacci2(long input, long expected) {
        assertEquals(expected, FibonacciMemoisation.fibonacciStream(input));
    }
}